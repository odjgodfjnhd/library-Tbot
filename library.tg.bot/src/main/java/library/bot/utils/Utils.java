        ...
        public static String buildHelpCommands() {
            return """
                Доступные команды:
                  ...
                  /add_book_year        -  указать год выпуска книге
                  /add_book_genre       -  указать, какого жанра книга
                  /set_status           -  поменять статус книге
                  ...
                  /add_note             -  добавить запись к книге
                  /show_notes           -  показать все записи к книге
                  /help                 -  вывести /help
                """;
        }
