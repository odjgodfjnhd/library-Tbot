...
public interface Utils {
    ...
    static void askBookName(String userName) {
        System.out.print("Отлично, " + userName + "! Теперь введите название книги: ");
    }

    static void askAuthorName(String bookName) {
    ...
    class Formatter {
        ...
        public static String buildBookInfoFull(User user, Book book, UserBookMetadata meta) {
            ...
            sb.append("Жанр книги: ")
                    .append(meta.getGenre() != null ? meta.getGenre() : "Вы ещё не указали жанр для этой книги.").append("\n");
            ...
            sb.append("Переводчик книги: ")
                    .append(meta.getBookTranslator() != null ? meta.getBookTranslator() : "Вы ещё не указали переводчика этой книги").append("\n");
            ...
            sb.append("Прогресс чтения: ")
                    .append(meta.getReadingStatus() != null && meta.getReadingStatus() ? "Книга прочитана" : "Книга не прочитана");
